function varargout=eantarcticaCoasts1(res,buf,rotb)  
% XY=EANTARCTICACOASTS1(res,buf,rotb)
% EANTARCTICACOASTS1(...) % Only makes a plot
%
...
elseif buf~=0
  fnpl=fullfile(whereitsat,sprintf('%s-%i-%g.mat','EantarcticaCoasts1',res,buf));
end
