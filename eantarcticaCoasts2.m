function varargout=eantarcticaCoasts2(res,buf,rotb)  
% XY=EANTARCTICACOASTS2(res,buf,rotb)
% EANTARCTICACOASTS2(...) % Only makes a plot
%
...
if res==0 && buf==0
  fnpl=fullfile(whereitsat,'EantarcticaCoasts2.mat');
elseif buf==0;
  fnpl=fullfile(whereitsat,sprintf('%s-%i.mat','EantarcticaCoasts2',res));
elseif buf~=0
  fnpl=fullfile(whereitsat,sprintf('%s-%i-%g.mat','EantarcticaCoasts2',res,buf));
end
