function varargout=wantarcticaG(res,buf)  
...
elseif buf~=0
  fnpl=fullfile(whereitsat,sprintf('%s-%i-%g.mat','WantarcticaG',res,buf));
end
...
if exist(fnpl,'file')==2 
  ...
  if res==0
    % First part %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    clf
    load(fullfile(getenv('IFILES'),'COASTS','WantarcticaG.mat'));
